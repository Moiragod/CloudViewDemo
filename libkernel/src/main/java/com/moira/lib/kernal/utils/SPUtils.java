...
public class SPUtils {
    ...
    private static SharedPreferences getSharedPreference(String fileName) {
        return MoiraCloudApplication.getInstance().getSharedPreferences(fileName, Context.MODE_PRIVATE);
    }
    ...
    public static boolean getNightMode() {
        return SPUtils.getBoolean(KEY_MODE_NIGHT, false);
    }

    public static void setNightMode(boolean nightMode) {
        SPUtils.putBoolean(KEY_MODE_NIGHT, nightMode);
    }
