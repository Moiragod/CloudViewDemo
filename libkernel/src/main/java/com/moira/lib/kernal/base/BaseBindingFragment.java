...
public abstract class BaseBindingFragment<SV extends ViewDataBinding> extends Fragment {
    ...
    /*
     * 有2种类型动画一类是drawable/load_amin是animationlist，一类是anim/common_progress属性动画
     * 后者通过AnimationUtils调用
     */
    private boolean isAttrAnim;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View ll = inflater.inflate(R.layout.fragment_base, null);
        mBindingView = DataBindingUtil.inflate(getActivity().getLayoutInflater(), getLayoutResId(), null, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mLoadingView = getView(R.id.img_progress);
        // 加载动画
